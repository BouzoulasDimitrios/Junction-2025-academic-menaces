...
Online Demo: [link](https://junction-2025-academic-menaces-bouzoulasdimitrios-projects.vercel.app/)

<p align="center">

<img src="./readme_resources/eeagleeye.gif" width = 80%> 
...
| Average RPM calculation                 |  ✅   |    ✅    |
| Individual Propeller<br>RPM calculation |  ❌   |    ✅    |
...
navigate under environments and install the environments using anaconda:
...
To run the basic script and generate an annotated mp4:

```bash
python ./src/basic/video_generator.py /path/to/your/input/file.dat \
    --output /path/to/your/output/file.mp4
    --blade n # with n (int) being the number of blades the drone is expected to have
    --window f # with f (float) representing accumulating intensity over time
```
